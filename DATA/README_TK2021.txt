Uitslagen verkiezing voor de Tweede Kamer (2021) op lijstniveau

Let op: dit is onderzoeksdata, en dus geen officiële verkiezingsuitslag!
Deze twee csv bestanden bevatten de uitslagen van de verkiezing voor de Tweede Kamer (2021) op lijstniveau, en zijn een verwerking van de EML bestanden van deze verkiezing op Gemeentelijk stembureauniveau.

Kolommen:

TK2021_Stemmen_Per_Lijst_Per_Gemeente.csv
-----
...
AantalStemmen:	Het aantal stemmen op deze partij, in deze gemeente


TK2021_Stemmen_Per_Lijst_Per_Stembureau.csv
-----
GemeenteCode:	Het gemeentenummer (CBS-codering) zonder voorloopnullen
GemeenteNaam:	De naam van de gemeente
